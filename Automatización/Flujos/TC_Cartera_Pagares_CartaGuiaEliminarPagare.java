...
public class TCCarteraPagaresCartaGuiaEliminarPagare {
  ...
  @Test
  public void testTCCarteraPagaresCartaGuiaEliminarPagare() throws Exception {
    ...
    driver.findElement(By.id("vELIMINARPAGARES_0001")).click();

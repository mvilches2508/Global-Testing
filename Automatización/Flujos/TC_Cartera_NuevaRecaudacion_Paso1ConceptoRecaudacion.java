...
public class TCCarteraNuevaRecaudacionPaso1ConceptoRecaudacion {
  ...
  @Test
  public void testTCCarteraNuevaRecaudacionPaso1ConceptoRecaudacion() throws Exception {
    ...
    driver.findElement(By.id("BTNENTER")).click();
    boolean proceso = isElementPresent(By.id("TEXTBLOCKTITLE"));

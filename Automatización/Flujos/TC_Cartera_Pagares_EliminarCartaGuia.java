...
public class TCCarteraPagaresEliminarCartaGuia {
  ...
  @Test
  public void testTCCarteraPagaresEliminarCartaGuia() throws Exception {
    ...
    String nomina1 = driver.findElement(By.xpath("//tr[5]/td[10]/span/a")).getText();
    driver.findElement(By.id("vDELETE_0005")).click();
    try {
    ...
    String nomina2 = driver.findElement(By.xpath("//tr[5]/td[10]/span/a")).getText();

...
public class TCCarteraPACReporteRendicionFechaError {
  ...
  @Test
  public void testTCCarteraPACReporteRendicionFechaError() throws Exception {
    ...
    driver.findElement(By.xpath("//div[7]/a[4]")).click();

...
public class TCCarteraGenerarPrepagoDacion {
  ...
  @Test
  public void testTCCarteraGenerarPrepagoDacion() throws Exception {
    ...
    new Select(driver.findElement(By.id("vTIPODEPREPAGO"))).selectByVisibleText("Dacion Pago");
    ...
    driver.findElement(By.id("vAUXCRENROOPE")).sendKeys("180230180");
    driver.findElement(By.id("vAUXCRENROOPE")).clear();
    driver.findElement(By.id("vAUXCRENROOPE")).sendKeys("");
    driver.findElement(By.id("vAUXCRENROOPE")).clear();
    ...
    driver.findElement(By.id("vNROCHASIS")).sendKeys("1655");
    driver.findElement(By.id("vNROMOTOR")).clear();
    driver.findElement(By.id("vNROMOTOR")).sendKeys("OP1802");
    driver.findElement(By.id("vKILOMETRAJE")).clear();
    driver.findElement(By.id("vKILOMETRAJE")).sendKeys("5000");
    driver.findElement(By.id("vCOLOR")).clear();
    driver.findElement(By.id("vCOLOR")).sendKeys("Azul oscuro");
    driver.findElement(By.id("BTNENTER")).click();
    try {

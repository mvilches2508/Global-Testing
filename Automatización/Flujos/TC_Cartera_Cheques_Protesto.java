...
public class TCCarteraChequesProtesto {
  ...
  @Test
  public void testTCCarteraChequesProtesto() throws Exception {
    ...
    driver.findElement(By.id("vPROTESTO_0001")).click();
    new Select(driver.findElement(By.id("vMOTIVOPROTESTOID"))).selectByVisibleText("CADUCADO");
    boolean protestarCheque = isElementPresent(By.xpath("//td"));
    driver.findElement(By.id("BTNENTER")).click();

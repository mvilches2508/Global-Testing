...
public class TCCarteraPagaresTrasladoAgregar {
  ...
  @Test
  public void testTCCarteraPagaresTrasladoAgregar() throws Exception {
    ...
    driver.findElement(By.id("INSERTARCARTAGUIATRASLADO")).click();
    new Select(driver.findElement(By.id("vUBICACIONESPAGARES"))).selectByVisibleText("Global Tesoreria");
    new Select(driver.findElement(By.id("vINVERSIONISTA"))).selectByVisibleText("No Aplica");
    new Select(driver.findElement(By.id("vUBICACIONESPAGAREFISICAID"))).selectByVisibleText("Global");
    new Select(driver.findElement(By.id("vMOTIVOTRASLADOID"))).selectByVisibleText("Tesorería");
    driver.findElement(By.name("BTNENTER")).click();

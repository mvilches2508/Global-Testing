...
public class TCCarteraChequesProtestoDepositado {
  ...
  @Test
  public void testTCCarteraChequesProtestoDepositado() throws Exception {
    ...
    driver.findElement(By.id("vCAMBIARESTADOADEPOSITADO_0001")).click();
    driver.findElement(By.id("vCHEQUEFECHADEPOSITO")).clear();
    driver.findElement(By.id("vCHEQUEFECHADEPOSITO")).sendKeys("151118");
    driver.findElement(By.id("vCHEQUENROCOMPROBANTE")).clear();
    driver.findElement(By.id("vCHEQUENROCOMPROBANTE")).sendKeys("11442018");

...
public class TCCarteraPACArchivoError {
  ...
  @Test
  public void testTCCarteraPACArchivoError() throws Exception {
    ...
    driver.findElement(By.xpath("//div[7]/a")).click();
    driver.findElement(By.id("fileuploadUPLOADIFYHTML51Container")).click();

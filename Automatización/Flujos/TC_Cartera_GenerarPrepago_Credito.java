...
public class TCCarteraGenerarPrepagoCredito {
  ...
  public void testTCCarteraGenerarPrepagoCredito() throws Exception {
    ...
    driver.findElement(By.id("BTNENTER")).click();
    try {
      assertEquals(driver.findElement(By.xpath("//span/div")).getText(), "No es posible generar el prepago : El crédito debe estar Contabilizado.");
    } catch (Error e) {

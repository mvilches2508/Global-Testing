...
public class TCCarteraPACGenerarNominaFechaError {
  ...
  @Test
  public void testTCCarteraPACGenerarNominaFechaError() throws Exception {
    ...
    driver.findElement(By.xpath("//div[7]/a[2]")).click();
    driver.findElement(By.id("BTNENTER")).click();
    try {
    ...
    driver.findElement(By.id("vFECHA")).click();
    driver.findElement(By.id("BTNENTER")).click();

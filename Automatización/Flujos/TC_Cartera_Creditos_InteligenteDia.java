...
public class TCCarteraCreditosInteligenteDia {
  ...
  @Test
  public void testTCCarteraCreditosInteligenteDia() throws Exception {
    ...
    driver.findElement(By.id("SDTCONVENIDO__DETCRECUO_0004")).sendKeys("345900");
    driver.findElement(By.id("SDTCONVENIDO__DETCREPAGTOT_0004")).clear();
    driver.findElement(By.id("SDTCONVENIDO__DETCREPAGTOT_0004")).sendKeys("345900");

...
public class TCCarteraRecaudacionExcelFormaPago {
  ...
  @Test
  public void testTCCarteraRecaudacionExcelFormaPago() throws Exception {
    ...
    boolean btnExcelFormaPago = isElementPresent(By.id("BTNFORMADEPAGO"));
    driver.findElement(By.id("BTNFORMADEPAGO")).click();
  }

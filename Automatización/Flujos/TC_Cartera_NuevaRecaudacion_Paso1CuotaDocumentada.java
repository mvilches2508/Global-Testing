...
public class TCCarteraNuevaRecaudacionPaso1CuotaDocumentada {
  ...
  public void testTCCarteraNuevaRecaudacionPaso1CuotaDocumentada() throws Exception {
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//span/div")).getText(), "No es posible recaudar esta cuota porque tiene cuotas anteriores documentadas");
    } catch (Error e) {
